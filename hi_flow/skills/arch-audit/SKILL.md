...
```
npx tsx hi_flow/skills/arch-audit/helpers/cli-run-audit.ts [--out-dir <path>] <project-root> [d9-md-path]
```
...
```
npx tsx hi_flow/skills/arch-audit/helpers/cli-render-md.ts \
