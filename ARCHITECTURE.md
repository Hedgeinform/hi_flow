...
- **Status:** BUILT (runtime v1, 2026-04-29) — 107 unit+integration tests green, 15 baseline rules (incl. barrel-file), 18 D9 principles. SKILL.md не написан — следующий этап.
