...
- **Frontend-profile activation (рефайнмент D27, 2026-06-06):** декларативная — `overrides.profile: frontend|backend` в `.audit-rules.yaml`, fallback — литеральная эвристика (≥2 из components/hooks/pages/features); feature-sliced раскладки требуют декларации. Контракт потребляют arch-spec/bootstrap. **Spec:** `docs/superpowers/specs/2026-06-06-hi_flow-frontend-slice-governance-amendment-design.md`.
